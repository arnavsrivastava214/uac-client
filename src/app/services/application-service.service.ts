...
export class ApplicationServiceService extends BaseServiceService {
  ...
  getTeacherById(userId: string, callback: any) {
    return this.getData(
      {},
      this.httpUrls['getTeacherById'] + '/' + userId,
      callback
    );
  }
  ...
  deleteTeacher(id: any, callback: any) {
    return this.deleteData(
      {},
      this.httpUrls['deleteTeacher'] + '/' + id,
      callback
    );
  }
  ...
  applyCareer(formData: FormData) {
    return this.http.post(
      'https://uac-server.onrender.com/api/uac/career/apply',
      formData
    );
  }
  ...
  uploadResultImages(formData: FormData, callback: any) {
    return this.postData(formData, '/api/uac/results/images/upload', callback);
  }
